...
public class Interface extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		TextField num_comp = new TextField();
		num_comp.setTranslateX(200);
		canvas.getChildren().add(num_comp);
		
		// Para revisar los prev de las compuertas
		Button button1 = new Button("Revisar Prev");
		button1.setTranslateX(100);
		canvas.getChildren().add(button1);
		button1.setOnAction(e -> {
			circuit.peekPrevNext(Integer.parseInt(num_comp.getText()));
		});
	
		// Boton de mostrar la tabla de verdad
		Button button2 = new Button("Mostrar tabla de verdad");
